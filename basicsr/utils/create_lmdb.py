...
def create_lmdb_for_rain13k():
    folder_path = '../../datasets/Rain13k/test/Test2800/input'
    lmdb_path = '../../datasets/Rain13k/test/Test2800/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '../../datasets/Rain13k/test/Test2800/target'
    lmdb_path = '../../datasets/Rain13k/test/Test2800/target.lmdb'

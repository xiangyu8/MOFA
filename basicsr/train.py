...
#            train_size = 5000*opt['frac_train']
#            train_set, _ = torch.utils.data.random_split(train_set, [train_size, len(train_set)-train_size],generator=torch.Generator().manual_seed(opt['manual_seed']))
...
#            total_iters = int(opt['train']['total_iter'])*opt['frac_train']*5000//30608
